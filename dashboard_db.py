...
**Когда идёт сбор.** Время задаётся ниже, в «Автосборе». Внешний сервис каждые 5 минут стучится в
...
**Вкладки.** «Текущее состояние» — последняя строка по каждой паре, отдельно по каждой стране.
«История» — все дни подряд. Отключённая пара пропадает из текущего состояния, но её история
остаётся: строки не удаляются никогда, а сами ASIN видны ниже, в списке «Больше не собираются».
"""
